...
public class EnvTemplateInstanceParameters {
	...
	/**
	 * optionnal extra properties (for comment, creationDate, user, retention,
	 * description, deployedVersionSet, ... )
	 */
	private final Map<String, FxNode> extraProperties;

	// ------------------------------------------------------------------------

	public EnvTemplateInstanceParameters(String envName, String sourceTemplateName,
			Map<String, FxNode> templateParameters, Map<String, FxNode> extraProperties) {
