...
/**
 * TODO should implements push/op StateAutomaton !!
 */
public class MethodCategory {
	...
	static  {
		...
		tmp.add(new MethodCategory("oracle.toplink.", PrintMode.START_END_ONLY, new String[] {
				"oracle.jdbc.",
				"weblogic.",
				"java.util.",
				"java.lang."
		...
		tmp.add(new MethodCategory("oracle.jms.AQjmsConsumer", PrintMode.START_END_ONLY, new String[] {
		...
		tmp.add(new MethodCategory("oracle.jms.AQjmsExceptionListener", PrintMode.START_END_ONLY, new String[] {
				"oracle.jdbc.",
				"oracle.sql.",
				"oracle.net.ns.",
				"java.net.",				
		...
		tmp.add(new MethodCategory("oracle.jdbc.", PrintMode.START_END_ONLY, new String[] {
				"java.util."
		}));
		...
		tmp.add(new MethodCategory("weblogic.kernel.ExecuteThread.run", PrintMode.START_END_ONLY, new String[] {
		...
		tmp.add(new MethodCategory("weblogic.jms.client.JMSSession.execute", PrintMode.START_END_ONLY, new String[] { 
				"weblogic.ejb20.internal.MDListener."
		}));
		
		tmp.add(new MethodCategory("weblogic.jdbc.", PrintMode.START_END_ONLY, new String[] {
				"oracle.jdbc.",
				"java.util."
		}));

		tmp.add(new MethodCategory("weblogicservlet.", PrintMode.START_END_ONLY, new String[] {
				"javax.servlet.",
				"weblogic.",				
				"java.lang.reflect.",
				"sun.reflect."
		...
		tmp.add(new MethodCategory("weblogic.webservice.", PrintMode.START_END_ONLY, new String[] {
				"java.langreflect.",
				"sun.reflect."
		}));

		tmp.add(new MethodCategory("weblogic.", PrintMode.START_END_ONLY, new String[] { 
				// "com.bea.utils.misc.ProcessManager", 
				"com.bea.",
				"java.lang.ClassLoader",
					"sun.misc.URLClassPath",
					"sun.misc.auncher$AppClassLoader",	
		...
		tmp.add(new MethodCategory("java.lang.ClassLoader.loadClassInternal", PrintMode.START_END_ONLY, new String[] { 
				"com.bea.utils.misc.ProcessFile.loadFileNew",
				"java.lang.ClassLoader.loadClass(",
				"sun.misc.Launher$AppClassLoader.loadClass("
		}));

		tmp.add(new MethodCategory("sun.misc.URLClassPath", PrintMode.START_END_ONLY, new String[] { 
				"java.net.URLClassLoader",
				"sun.misc.URLClassPath",
				"java.security.AccessController",
				"java.util.jar.JarFile",
		...
		tmp.add(new MethodCategory("java.util.TimerThread.run(", PrintMode.START_END_ONLY, new String[] {
				"java.util.TimerThread.mainLoop(",
				"java.lang.Object.wait("
		}));
		
		
		tmp.add(new MethodCategory("javax.servlet.http.HttpServlet.service", PrintMode.START_END_ONLY, new String[] {
				"weblogic.servlet.",
				// "weblogic.webservice."
		}));
